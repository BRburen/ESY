...
final public class GirftMessage : GeneratedMessage {
    public typealias BuilderType = GirftMessage.Builder

    public static func == (lhs: GirftMessage, rhs: GirftMessage) -> Bool {
        if lhs === rhs {
            return true
        }
        var fieldCheck:Bool = (lhs.hashValue == rhs.hashValue)
    ...
    public fileprivate(set) var giftCount:Int64! = nil
    ...
    override public func isInitialized() throws {
        if !hasUser {
            throw ProtocolBuffersError.invalidProtocolBuffer("Uninitialized Message \(GirftMessage.self): field \"user\" mark required")
        }
        if !hasGiftName {
            throw ProtocolBuffersError.invalidProtocolBuffer("Uninitialized Message \(GirftMessage.self): field \"giftName\" mark required")
        }
        if !hasGiftUrl {
            throw ProtocolBuffersError.invalidProtocolBuffer("Uninitialized Message \(GirftMessage.self): field \"giftUrl\" mark required")
        }
        if !hasGiftCount {
            throw ProtocolBuffersError.invalidProtocolBuffer("Uninitialized Message \(GirftMessage.self): field \"giftCount\" mark required")
        }
        try user.isInitialized()
    }
    override public func writeTo(codedOutputStream: CodedOutputStream) throws {
        ...
        if hasGiftCount {
            try codedOutputStream.writeInt64(fieldNumber: 4, value:giftCount)
        }
        try unknownFields.writeTo(codedOutputStream: codedOutputStream)
    }
    override public func serializedSize() -> Int32 {
        ...
        if hasGiftCount {
            serialize_size += giftCount.computeInt64Size(fieldNumber: 4)
        }
        serialize_size += unknownFields.serializedSize()
        memoizedSerializedSize = serialize_size
        return serialize_size
    }
    public class func getBuilder() -> GirftMessage.Builder {
        return GirftMessage.classBuilder() as! GirftMessage.Builder
    }
    public func getBuilder() -> GirftMessage.Builder {
        return classBuilder() as! GirftMessage.Builder
    }
    override public class func classBuilder() -> ProtocolBuffersMessageBuilder {
        return GirftMessage.Builder()
    }
    override public func classBuilder() -> ProtocolBuffersMessageBuilder {
        return GirftMessage.Builder()
    }
    public func toBuilder() throws -> GirftMessage.Builder {
        return try GirftMessage.builderWithPrototype(prototype:self)
    }
    public class func builderWithPrototype(prototype:GirftMessage) throws -> GirftMessage.Builder {
        return try GirftMessage.Builder().mergeFrom(other:prototype)
    }
    override public func encode() throws -> Dictionary<String,Any> {
        try isInitialized()
        var jsonMap:Dictionary<String,Any> = Dictionary<String,Any>()
    ...
    override class public func decode(jsonMap:Dictionary<String,Any>) throws -> GirftMessage {
        return try GirftMessage.Builder.decodeToBuilder(jsonMap:jsonMap).build()
    }
    override class public func fromJSON(data:Data) throws -> GirftMessage {
        return try GirftMessage.Builder.fromJSONToBuilder(data:data).build()
    }
    override public func getDescription(indent:String) throws -> String {
        var output = ""
        if hasUser {
    ...
    final public class Builder : GeneratedMessageBuilder {
        fileprivate var builderResult:GirftMessage = GirftMessage()
        public func getMessage() -> GirftMessage {
            return builderResult
        }
        ...
        @discardableResult
        public func setUser(_ value:UserInfo!) -> GirftMessage.Builder {
            self.user = value
            return self
        }
        @discardableResult
        public func mergeUser(value:UserInfo) throws -> GirftMessage.Builder {
            if builderResult.hasUser {
                builderResult.user = try UserInfo.builderWithPrototype(prototype:builderResult.user).mergeFrom(other: value).buildPartial()
            } else {
                builderResult.user = value
        ...
        @discardableResult
        public func clearUser() -> GirftMessage.Builder {
            userBuilder_ = nil
            builderResult.hasUser = false
            builderResult.user = nil
            return self
        ...
        @discardableResult
        public func setGiftName(_ value:String) -> GirftMessage.Builder {
            self.giftName = value
            return self
        }
        @discardableResult
        public func clearGiftName() -> GirftMessage.Builder{
        ...
        @discardableResult
        public func setGiftUrl(_ value:String) -> GirftMessage.Builder {
            self.giftUrl = value
            return self
        }
        @discardableResult
        public func clearGiftUrl() -> GirftMessage.Builder{
            builderResult.hasGiftUrl = false
            builderResult.giftUrl = nil
            return self
        }
        public var giftCount:Int64 {
            get {
        ...
        @discardableResult
        public func setGiftCount(_ value:Int64) -> GirftMessage.Builder {
            self.giftCount = value
            return self
        }
        @discardableResult
        public func clearGiftCount() -> GirftMessage.Builder{
        ...
        @discardableResult
        override public func clear() -> GirftMessage.Builder {
            builderResult = GirftMessage()
            return self
        }
        override public func clone() throws -> GirftMessage.Builder {
            return try GirftMessage.builderWithPrototype(prototype:builderResult)
        }
        override public func build() throws -> GirftMessage {
            try checkInitialized()
            return buildPartial()
        }
        public func buildPartial() -> GirftMessage {
            let returnMe:GirftMessage = builderResult
            return returnMe
        }
        @discardableResult
        public func mergeFrom(other:GirftMessage) throws -> GirftMessage.Builder {
            if other == GirftMessage() {
                return self
            }
            if (other.hasUser) {
                try mergeUser(value: other.user)
        ...
        @discardableResult
        override public func mergeFrom(codedInputStream: CodedInputStream) throws -> GirftMessage.Builder {
            return try mergeFrom(codedInputStream: codedInputStream, extensionRegistry:ExtensionRegistry())
        }
        @discardableResult
        override public func mergeFrom(codedInputStream: CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> GirftMessage.Builder {
            let unknownFieldsBuilder:UnknownFieldSet.Builder = try UnknownFieldSet.builderWithUnknownFields(copyFrom:self.unknownFields)
            while (true) {
                let protobufTag = try codedInputStream.readTag()
                switch protobufTag {
                ...
                case 32:
                    giftCount = try codedInputStream.readInt64()
        ...
        class override public func decodeToBuilder(jsonMap:Dictionary<String,Any>) throws -> GirftMessage.Builder {
            let resultDecodedBuilder = GirftMessage.Builder()
            if let jsonValueUser = jsonMap["user"] as? Dictionary<String,Any> {
                resultDecodedBuilder.user = try UserInfo.Builder.decodeToBuilder(jsonMap:jsonValueUser).build()
            ...
            if let jsonValueGiftCount = jsonMap["giftCount"] as? String {
                resultDecodedBuilder.giftCount = Int64(jsonValueGiftCount)!
            } else if let jsonValueGiftCount = jsonMap["giftCount"] as? Int {
                resultDecodedBuilder.giftCount = Int64(jsonValueGiftCount)
            }
            return resultDecodedBuilder
        }
        override class public func fromJSONToBuilder(data:Data) throws -> GirftMessage.Builder {
            let jsonData = try JSONSerialization.jsonObject(with:data, options: JSONSerialization.ReadingOptions(rawValue: 0))
            guard let jsDataCast = jsonData as? Dictionary<String,Any> else {
              throw ProtocolBuffersError.invalidProtocolBuffer("Invalid JSON data")
            }
            return try GirftMessage.Builder.decodeToBuilder(jsonMap:jsDataCast)
        }
    }
...
extension GirftMessage: GeneratedMessageProtocol {
    public class func parseArrayDelimitedFrom(inputStream: InputStream) throws -> Array<GirftMessage> {
        var mergedArray = Array<GirftMessage>()
        while let value = try parseDelimitedFrom(inputStream: inputStream) {
          mergedArray.append(value)
        }
        return mergedArray
    }
    public class func parseDelimitedFrom(inputStream: InputStream) throws -> GirftMessage? {
        return try GirftMessage.Builder().mergeDelimitedFrom(inputStream: inputStream)?.build()
    }
    public class func parseFrom(data: Data) throws -> GirftMessage {
        return try GirftMessage.Builder().mergeFrom(data: data, extensionRegistry:ImmessageRoot.default.extensionRegistry).build()
    }
    public class func parseFrom(data: Data, extensionRegistry:ExtensionRegistry) throws -> GirftMessage {
        return try GirftMessage.Builder().mergeFrom(data: data, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFrom(inputStream: InputStream) throws -> GirftMessage {
        return try GirftMessage.Builder().mergeFrom(inputStream: inputStream).build()
    }
    public class func parseFrom(inputStream: InputStream, extensionRegistry:ExtensionRegistry) throws -> GirftMessage {
        return try GirftMessage.Builder().mergeFrom(inputStream: inputStream, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFrom(codedInputStream: CodedInputStream) throws -> GirftMessage {
        return try GirftMessage.Builder().mergeFrom(codedInputStream: codedInputStream).build()
    }
    public class func parseFrom(codedInputStream: CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> GirftMessage {
        return try GirftMessage.Builder().mergeFrom(codedInputStream: codedInputStream, extensionRegistry:extensionRegistry).build()
    }
    public subscript(key: String) -> Any? {
        switch key {
        case "user": return self.user
...
extension GirftMessage.Builder: GeneratedMessageBuilderProtocol {
    public typealias GeneratedMessageType = GirftMessage
    public subscript(key: String) -> Any? {
        get { 
            switch key {
            case "user": return self.user
